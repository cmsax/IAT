    ...
    <div class="container">
      ...
      >
        ...
        <el-tab-pane label="项目简介" name="welcome" :disabled="true">
          <h2>项目简介</h2>
          <p>
            您将完成一些简短的调查表和一个内隐关联测试，请您尽快将单词和图片分类。这项研究可以帮助我们了解人们对美味食物的一些看法，这份问卷应该可以在10分钟内完成。
          </p>
          <p>
            我们收集的必要数据及原因：
            <ul>
              <li>您提交数据时的 IP 地址，这用于区分不同用户；</li>
              <li>您的非敏感的基本信息，这是问卷的一部分；</li>
              <li>您在本页面上的活动，这有助于我们分析用户所提交数据的质量。</li>
            </ul>
          </p>
          <p>您的数据将会被安全地传输。如果您有任何疑问，欢迎联系 <a href="mailto:i.feiweiwei@gmail.com">i.feiweiwei@gmail.com</a>。</p>
